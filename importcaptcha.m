path = fullfile(fileparts(mfilename('fullpath')), 'trainset');
for i = 1:6;
which_testset = i;
...
% u images = slike za treniranje, trainlabels su labele njihove
% u testImages = slike za testiranje, testlabels su njihove labele
% u testlabelsnew i trainlabelsnew su imena grupa : 1-62
